...
const success = async (pluginConfig, { nextRelease, logger }) => {
  ...
  logger.log(execSync(`git clone ${repoOrigin} .`, options)) /*Vulnerability name: Indirect uncontrolled command line	Vulnerability description: Forwarding command-line arguments to a child process executed within a shell may indirectly introduce command-line injection vulnerabilities.	Vulnerability message: This command depends on an unsanitized [["environment variable"|"relative:///tools/update-docs.js:15:33:15:43"]].*/

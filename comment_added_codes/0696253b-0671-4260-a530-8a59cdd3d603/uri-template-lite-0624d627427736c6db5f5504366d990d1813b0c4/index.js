...
!function(URI) {
	...
	, SEPARATORS = {"": ",", "+": ",", "#": ",", "?": "&"}
	, escapeRe = /[$-\/?[-^{|}]/g
	, expandRe = /\{([#&+.\/;?]?)((?:[-\w%.]+(\*|:\d+)?,?)+)\}/g /*	Vulnerability name: Inefficient regular expression	Vulnerability description: A regular expression that requires exponential time to match certain inputs can be a performance bottleneck, and may be vulnerable to denial-of-service attacks.	Vulnerability message: This part of the regular expression may cause exponential backtracking on strings starting with '{' and containing many repetitions of '%'.*/ /*	Vulnerability name: Inefficient regular expression	Vulnerability description: A regular expression that requires exponential time to match certain inputs can be a performance bottleneck, and may be vulnerable to denial-of-service attacks.	Vulnerability message: This part of the regular expression may cause exponential backtracking on strings starting with '{%:' and containing many repetitions of '90%:'.*/

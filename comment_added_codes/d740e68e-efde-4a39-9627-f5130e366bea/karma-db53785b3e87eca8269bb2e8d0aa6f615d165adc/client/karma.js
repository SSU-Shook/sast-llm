...
function Karma (updater, socket, iframe, opener, navigator, location, document) {
  ...
  this.complete = function (result) {
    ...
    if (returnUrl) {
      location.href = returnUrl /*	Vulnerability name: Client-side URL redirect	Vulnerability description: Client-side URL redirection based on unvalidated user input may cause redirection to malicious web sites.	Vulnerability message: Untrusted URL redirection depends on a [["user-provided value"|"relative:///client/karma.js:9:43:9:57"]].*/ /*	Vulnerability name: Client-side cross-site scripting	Vulnerability description: Writing user input directly to the DOM allows for a cross-site scripting vulnerability.	Vulnerability message: Cross-site scripting vulnerability due to [["user-provided value"|"relative:///client/karma.js:9:43:9:57"]].*/
    }
  }

...
describe('middleware.source_files', function () {
  ...
  function createServer (f, s, basePath) {
    ...
    return http.createServer(function (req, res) { /*	Vulnerability name: Missing X-Frame-Options HTTP header	Vulnerability description: If the 'X-Frame-Options' setting is not provided, a malicious user may be able to overlay their own UI on top of the site by using an iframe.	Vulnerability message: This server never sets the 'X-Frame-Options' HTTP header.*/

...
describe('web-server', () => {
  ...
  describe('https', () => {
    ...
    it('should serve client.html', () => {
      ...
      process.env.NODE_TLS_REJECT_UNAUTHORIZED = '0' /*	Vulnerability name: Disabling certificate validation	Vulnerability description: Disabling cryptographic certificate validation can cause security vulnerabilities.	Vulnerability message: Disabling certificate validation is strongly discouraged.*/
